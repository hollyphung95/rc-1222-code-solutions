...
function renderPokemon(pokemon) {
  ...
  for (var i = 0; i < pokedex.length - 1; i++) {
    ...
    $cardImg.setAttribute('src', pokedex[i].imageUrl);
    $cardText.textContent = pokedex[i].description;

    $newContainer.appendChild($newWrapper);
    $newWrapper.appendChild($cardImg);
    $newWrapper.appendChild($cardText);

    var $paragraph = pokedex[i].description;
